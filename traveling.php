    ...
    <div  class="container-fluid">
        <ul class="cb-slideshow traveling">
            <li><span></span><div><h3>TRAVELING<br><br></h3></div></li>
        </ul>
    </div>
    <div class="container">
        <div id="state" class="text-nadpis-1">
            EUROPE
        </div>
        <div class="mapa">
    ...
    $(document).ready(function () {
        ...
        d3.json("data/data1.json", function (error, graphData) {
            var container = svg.selectAll(".subunit")
                .data(topojson.feature(graphData, graphData.objects.subunits).features)
                .enter()
                .append("g");
